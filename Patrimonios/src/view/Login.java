...
public class Login extends JFrame implements ActionListener {
	...
	public Login() {
		...
		// Executa a query e adiciona os usernames e senhas no arraylist dados
			...
			public void actionPerformed(ActionEvent e) {
				for (String teste : dados) {
					try {
						...
						JOptionPane.showMessageDialog(null, "User or password incorrects");
					}
				}
			}
		});
